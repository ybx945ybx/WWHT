...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private void takeRefreshGallery(PhotoInfo photoInfo) {
        ...
        if (mAllPhotoFolderList != null && mAllPhotoFolderList.size() > 0) {
            photoInfoList = mAllPhotoFolderList.get(0).getPhotoList();
        }
    ...
    private void requestGalleryPermission() {
        if (EasyPermissions.hasPermissions(this, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA)) {
            ...
            EasyPermissions.requestPermissions(this, getString(R.string.permissions_tips_gallery),
                    GalleryFinal.PERMISSIONS_CODE_GALLERY, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA);
        }
    }
