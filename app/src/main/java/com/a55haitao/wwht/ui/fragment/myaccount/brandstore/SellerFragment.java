 ...
 */
public class SellerFragment extends BrandSellerBaseFragment {
    @Override
    ...
    protected void requestFollowBrandStore(CheckBox chkFollowBrandStore, String nameen) {
        ProductRepository.getInstance()
                .followBrandSeller(PageType.SELLER, nameen)
    ...
    protected void requestBrandStoreList() {
        ...
        if (mUserId == 0) { // 个人主页
            followBrandStore = ProductRepository.getInstance()
                    .getFollowBrandStore(BrandSellerFragmentType.SELLER, mCurrentPage);
        } else { // 他人主页
            followBrandStore = ProductRepository.getInstance()
                    .getFollowBrandStore(BrandSellerFragmentType.SELLER, mCurrentPage, mUserId);
        }
