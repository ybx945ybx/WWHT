...
public class HaiImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            TypedArray t = context.obtainStyledAttributes(attrs, R.styleable.HaiImageView);
            ratio = t.getFloat(R.styleable.HaiImageView_viewAspectRatio, DEFAULT_RATTIO);
            t.recycle();
        }
